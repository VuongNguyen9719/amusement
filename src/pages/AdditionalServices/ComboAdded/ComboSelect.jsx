            ...
            >
                <div className="flex gap-2 flex-wrap ">
                    <div className="flex p-[6px] items-center justify-center gap-x-1 rounded bg-[#EEF2FF] ">
                        <span className="text-[#364152] text-xs not-italic font-medium leading-4">Nước M</span>
                        <div className="flex w-4 h-4 items-center justify-center p-1 rounded-[99px] bg-white"><span className="text-[#4F46E5] not-italic font-semibold text-[10px]">3</span></div>
                    </div>
                    <div className="flex p-[6px] items-center justify-center gap-x-1 rounded bg-[#EEF2FF] ">
                        <span className="text-[#364152] text-xs not-italic font-medium leading-4">Nước M</span>
                        <div className="flex w-4 h-4 items-center justify-center p-1 rounded-[99px] bg-white"><span className="text-[#4F46E5] not-italic font-semibold text-[10px]">3</span></div>
